      ...
      {isSuccess && (
        <div className="p-4 rounded-xl border border-emerald-200 bg-emerald-50 text-emerald-800 flex items-center gap-3 animate-in fade-in slide-in-from-top-2 duration-500">
          ...
          <p className="text-sm font-semibold">
            Booking confirmed! We've sent the details to your email.
          </p>
        </div>
      )}
    </div>
...
export default function ClientBookingsPage() {
  return (
    <div className="space-y-8">
        ...
        <CardContent>
          <div className="p-6 rounded-xl border border-border bg-secondary/30 flex flex-col sm:flex-row gap-6 items-start sm:items-center justify-between">
            <div className="flex gap-4 items-center">
              <div className="h-16 w-16 bg-muted rounded-xl flex items-center justify-center text-2xl">
                👨‍🍳
              </div>
              <div>
                ...
                <div className="flex items-center gap-4 text-sm text-muted-foreground mt-2">
                  <span className="flex items-center gap-1">
                    <Calendar className="h-4 w-4" /> Dec 31, 2026 - 7:00 PM
                  </span>
                  <span className="flex items-center gap-1">
                    <MapPin className="h-4 w-4" /> 123 Main St, New York
                  </span>
                </div>
              </div>
            </div>
      ...
      <h3 className="text-xl font-bold tracking-tight mt-12 mb-4">
        Past Experiences
      </h3>
