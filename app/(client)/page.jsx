    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="bg-primary text-primary-foreground py-32 relative overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 text-center">
          <svg
            className="mx-auto h-12 w-12 text-accent opacity-50 mb-8"
            fill="currentColor"
            viewBox="0 0 24 24"
          >
          ...
          <blockquote className="text-3xl sm:text-4xl md:text-5xl font-serif text-white leading-tight mb-12 drop-shadow-sm font-medium">
            "The easiest way to host a dinner party. The food was simply
            incredible, and waking up to a spotless kitchen the next day was
            purely magical."
          </blockquote>
          <div className="flex items-center justify-center gap-5">
            ...
            <div className="text-left">
              <div className="font-semibold text-lg text-white font-serif">
                Sarah Jenkins
              </div>
              <div className="text-primary-foreground/70 font-medium">
                Hosted a 10-person birthday dinner
              </div>
            </div>
          </div>
        </div>
