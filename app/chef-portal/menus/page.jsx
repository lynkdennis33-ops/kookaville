  ...
  const [menus, setMenus] = useState([
    {
      ...
      price: 150,
      description:
        "A 5-course culinary journey highlighting seasonal, local ingredients with modern French techniques.",
    ...
    },
    {
      ...
      price: 90,
      description:
        "Generous portions of handmade pasta, braised meats, and classic Italian desserts perfect for sharing.",
    ...
    },
    {
      ...
      price: 200,
      description:
        "Omakase-style sushi dinner featuring premium cuts of fish flown in directly from Japan.",
      dietary: ["Pescatarian"],
      status: "Draft",
      courses: 8,
      image:
    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Create, edit, and organize the menus you offer to clients.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
        {menus.map((menu) => (
          <div
            key={menu.id}
            className="border border-border rounded-2xl bg-card overflow-hidden flex flex-col sm:flex-row transition-colors hover:border-primary/30"
          >
              ...
              <div>
                <div className="flex justify-between items-start mb-2">
                  ...
                  <div className="font-bold text-accent text-xl">
                    ${menu.price}{" "}
                    <span className="text-xs font-normal text-muted-foreground block text-right mt-[-4px]">
                      /person
                    </span>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4 text-xs font-semibold text-muted-foreground mb-4">
                  ...
                  <div className="flex gap-1">
                    {menu.dietary.map((d, i) => (
                      <span
                        key={i}
                        className="text-emerald-600 bg-emerald-50 px-2 py-1 rounded-md"
                      >
                        {d}
                      </span>
                    ))}
