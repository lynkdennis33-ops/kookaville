      ...
      <div className="grid gap-8">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Update your public chef profile details.
            </CardDescription>
          </CardHeader>
            ...
            <div className="flex flex-col sm:flex-row gap-6">
              ...
              <div className="flex-1 space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    defaultValue="Award-winning chef with 15 years of culinary excellence in fine dining."
                    rows={3}
                  />
                </div>
              </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Configure how you receive bookings.
            </CardDescription>
          </CardHeader>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Allow clients to book without manual approval.
                  </p>
                </div>
              </div>
