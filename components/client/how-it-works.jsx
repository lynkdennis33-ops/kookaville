  ...
  const steps = [
    {
      ...
      description:
        "Browse our curated list of world-class private chefs based on location, cuisine, or specific dietary needs.",
      icon: Search,
    },
    {
      title: "Customize Menu",
      description:
        "Collaborate directly with your chef to tailor a menu perfectly suited for your event or dining preference.",
      icon: UtensilsCrossed,
    },
    {
      title: "Book Details",
      description:
        "Reserve your date securely. Your chef handles the ingredients, cooking, and the cleanup.",
      icon: CalendarDays,
    },
    {
      title: "Enjoy the Experience",
      description:
        "Relax and savor an unforgettable, restaurant-quality meal right in the comfort of your own home.",
      icon: Star,
    },
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 relative">
          ...
          {steps.map((step, index) => (
            ...
            >
              ...
              <h3 className="text-xl font-semibold font-serif tracking-tight mb-3 text-foreground">
                {step.title}
              </h3>
