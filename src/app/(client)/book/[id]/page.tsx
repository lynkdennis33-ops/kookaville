...
import { ChevronLeft, CreditCard, ShieldCheck, Info, Star } from 'lucide-react';
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-8 md:py-12">
      ...
      <div className="flex items-center gap-4 mb-8">
        <Button variant="ghost" size="icon" onClick={() => step === 1 ? router.back() : handleBack()}>
          <ChevronLeft className="h-6 w-6" />
        </Button>
        <h1 className="text-3xl font-bold tracking-tight text-foreground">Complete your booking</h1>
      </div>
                      ...
                      <div>
                        ...
                        <Select 
                          options={[
                            ...
                            { value: 'romantic', label: 'Romantic Dinner for 2' },
                ...
                <div className="space-y-8">
                  ...
                  <div className="space-y-6 max-w-md">
                    ...
                    <div className="flex items-center justify-between pb-6 border-b border-border">
                      ...
                      <div className="flex items-center gap-4">
                        <Button variant="outline" size="icon" className="rounded-full h-8 w-8 disabled:opacity-50" disabled>-</Button>
                  ...
                  <div className="max-w-xl">
                    <h3 className="text-lg font-bold mb-3">Dietary Needs & Special Requests</h3>
                    <Textarea 
                ...
                <div className="space-y-8">
                      ...
                      <div className="flex-1">
                        <div className="font-semibold flex justify-between items-center">
                          ...
                          <div className="flex gap-1 h-5">
                            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/2a/Mastercard-logo.svg/1000px-Mastercard-logo.svg.png" alt="MC" className="h-full object-contain" />
                            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/5/5e/Visa_Inc._logo.svg/1000px-Visa_Inc._logo.svg.png" alt="Visa" className="h-full object-contain" />
                          </div>
                        </div>
                        <div className="mt-4 space-y-4">
                          <Input placeholder="Card number" defaultValue="**** **** **** 4242" />
                  ...
                  <div className="pt-6 border-t border-border max-w-xl">
                    <p className="text-xs text-muted-foreground mb-4">
                      By selecting the button below, I agree to the Host's House Rules, Ground rules for guests, Lumière's Rebooking and Refund Policy, and that Lumière can charge my payment method.
                    </p>
                    <Button size="lg" className="w-full sm:w-auto px-12 bg-accent hover:bg-accent/90" onClick={handleConfirm} isLoading={isLoading}>
                      Confirm and pay
                    </Button>
                  </div>
                </div>
        ...
        <div className="w-full lg:w-1/3 relative lg:mt-6">
          <div className="sticky top-24 border border-border rounded-2xl p-6 shadow-card bg-card mb-8">
            <div className="flex gap-4 items-start border-b border-border pb-6 mb-6">
              <img src={chef.avatar} alt={chef.name} className="w-24 h-24 rounded-xl object-cover" />
              <div>
                <div className="text-xs text-muted-foreground uppercase tracking-wider mb-1">Private Chef</div>
            ...
            <div className="space-y-3 text-sm mb-6">
              ...
              <div className="flex justify-between">
                <span className="underline decoration-dotted cursor-help">Taxes</span>
            ...
            <div className="flex justify-between font-bold text-lg pt-4 border-t border-border">
              <span>Total (USD)</span>
              <span>${(chef.pricePerPerson * 4) + 45 + Math.round((chef.pricePerPerson * 4) * 0.08)}</span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4 bg-secondary/50 p-6 rounded-xl border border-secondary">
            ...
            <p className="text-sm font-medium">
              Payment is held securely by Lumière and only released to the chef 24h after your event.
            </p>
          </div>
        </div>
      </div>
