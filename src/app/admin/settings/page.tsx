  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-muted-foreground">Configure platform-wide settings and security.</p>
      </div>
      ...
      <div className="grid gap-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Manage administrative access rules.</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between p-3 border border-border rounded-xl">
                <div className="flex items-center gap-3">
                  <Shield className="h-5 w-5 text-muted-foreground" />
                  <span className="text-sm font-medium">Multi-Factor Auth (2FA)</span>
                </div>
              ...
              <Button variant="outline" className="w-full">Manage Admin Roles</Button>
            </CardContent>
          </Card>
        </div>
        ...
        <Card className="border-red-200">
          <CardHeader>
            ...
            <CardDescription>Take the platform offline for updates.</CardDescription>
          </CardHeader>
          <CardContent>
            <p className="text-sm text-muted-foreground mb-4">
              Enabling maintenance mode will restrict access to all users except admins.
            </p>
