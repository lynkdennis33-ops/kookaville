...
import { ChefHat, LogOut, LayoutDashboard, Calendar, Utensils, DollarSign, Settings, Users, ClipboardList } from 'lucide-react';
...
export function Sidebar({ items, role }: { items: SidebarItem[], role: string }) {
      ...
      <div className="p-6">
        <Link href="/" className="flex items-center gap-2 mb-8">
          ...
          <span className="font-bold text-xl tracking-tight text-primary">
            Lumière <span className="text-sm font-normal text-muted-foreground ml-1 capitalize">{role}</span>
          </span>
        </Link>
